...
<body>
    <svg id="page-overlay-svg" xmlns="http://www.w3.org/2000/svg"></svg>

    <div class="header">
        <h1 id="name">Авдеев Владислав Александрович</h1>
        <h3>Группа: P3214</h3>
        <h3>Вариант: 464917</h3>
    </div>
        ...
        <div id="graphic">
            <div id="svg-wrapper">
                <svg height="500" width="500" xmlns="http://www.w3.org/2000/svg" id="graph-svg">
                    ...
                    <line stroke="#A1A6B4" x1="330" x2="330" y1="255" y2="245"></line>
                    <line stroke="#A1A6B4" x1="410" x2="410" y1="255" y2="245"></line>
                    <line stroke="#A1A6B4" x1="170" x2="170" y1="255" y2="245"></line>
                    <line stroke="#A1A6B4" x1="90" x2="90" y1="255" y2="245"></line>
                    <line stroke="#A1A6B4" x1="255" x2="245" y1="170" y2="170"></line>
                    <line stroke="#A1A6B4" x1="255" x2="245" y1="90" y2="90"></line>
                    <line stroke="#A1A6B4" x1="255" x2="245" y1="330" y2="330"></line>
                    <line stroke="#A1A6B4" x1="255" x2="245" y1="410" y2="410"></line>
                    ...
                    <path d="M 250 410 A 160, 160, 0, 0, 1, 90 250 L 250 250 Z"
                          fill-opacity="0.8" fill="#B4D2E7" stroke="#000000"></path>
            ...
            <div id='rValue'></div>
            <div id='coordinates'>Координаты не были выбраны</div>
        </div>

        <!-- прозрачный слой для кликов -->
