...
Доп для данной лабораторной работы:
Добавить поведение для тыкания по графику (всей странице):
При нажатии на области графика - не попал, пусть включается музыка, ее не должно быть возможности отключить, с каждой ошибкой громкость выше, отключается только после попадания в область. нажимать и указывать координаты нужно на всей странице, кроме кнопок отправки и тп. То есть не ограничиваться графиком с осями xOy
